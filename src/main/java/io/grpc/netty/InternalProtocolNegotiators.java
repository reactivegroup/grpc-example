...
public final class InternalProtocolNegotiators {
  ...
  public static InternalProtocolNegotiator.ProtocolNegotiator tls(SslContext sslContext) {
    final ProtocolNegotiator negotiator = ProtocolNegotiators.tls(sslContext);
  ...
  public static InternalProtocolNegotiator.ProtocolNegotiator serverTls(SslContext sslContext) {
    final ProtocolNegotiator negotiator = ProtocolNegotiators.serverTls(sslContext);
  ...
  public static InternalProtocolNegotiator.ProtocolNegotiator plaintext() {
    final ProtocolNegotiator negotiator = ProtocolNegotiators.plaintext();
  ...
  public static InternalProtocolNegotiator.ProtocolNegotiator serverPlaintext() {
    final ProtocolNegotiator negotiator = ProtocolNegotiators.serverPlaintext();
