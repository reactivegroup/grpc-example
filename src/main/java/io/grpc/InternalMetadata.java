...
public final class InternalMetadata {
  ...
  /**
   * Serializes all metadata entries, leaving some values as {@link java.io.InputStream}s.
   *
   ...
   * method. Values are either byte arrays or {@link java.io.InputStream}s.
   */
  @Internal
   ...
   *
   * @param marshaller The {@link BinaryStreamMarshaller} associated with this value.
