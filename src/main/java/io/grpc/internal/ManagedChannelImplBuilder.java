...
public final class ManagedChannelImplBuilder
   ...
   * NameResolver} for use in cases where the target string doesn't include a port. The
   ...
   * NameResolver}-compliant URI, or an authority string. Transport implementors must
