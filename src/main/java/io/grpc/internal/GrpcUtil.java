...
public final class GrpcUtil {
  ...
  /**
   * {@link Metadata.Key} for the accepted message encodings header.
   */
  ...
  /**
   * {@link Metadata.Key} for the stream's content encoding header.
   */
  ...
  /**
   * {@link Metadata.Key} for the stream's accepted content encoding header.
   */
  ...
  /**
   * {@link Metadata.Key} for the Transfer encoding.
   */
  ...
  private static final String IMPLEMENTATION_VERSION = "1.35.1-SNAPSHOT"; // CURRENT_GRPC_VERSION
  ...
  /**
   * RPCs created on the Channel returned by {@link Subchannel#asChannel}
