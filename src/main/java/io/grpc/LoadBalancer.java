 ...
 *       {@link Helper#getSynchronizationContext}.  It receives the results
 ...
 * synchronization among them.  {@link Helper#getSynchronizationContext}
 ...
 * SubchannelStateListener#onSubchannelState onSubchannelState()} how to do
 * this properly.
 *
...
public abstract class LoadBalancer {
  ...
  public abstract static class Helper {
     ...
     *
     * @since 1.2.0
     * @deprecated Use {@link #createSubchannel(CreateSubchannelArgs)}
    ...
    /**
     * Equivalent to {@link #updateSubchannelAddresses(Subchannel, List)} with
